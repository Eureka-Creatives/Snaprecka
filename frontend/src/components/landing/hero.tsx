export default function Hero() {
  return (
    <section className="font-dm flex min-h-screen flex-col items-center w-full justify-start pt-60 px-10">
      <div className="flex flex-col justify-center items-center gap-4">
        ...
        <h1 className="text-[110px] font-medium text-black font-dm group">
          Your{" "}
